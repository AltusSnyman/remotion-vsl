...
export const Scene01_Hook: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg, opacity: fadeOut }}>
      ...
      <ParticleField color={COLORS.purple} opacity={0.15} particleCount={30} seed="hook" speed={0.5} />
      <GlowOrb color={COLORS.purple} x={50} y={45} size={600} speed={0.4} />
      <GlowOrb color={COLORS.red} x={30} y={60} size={300} speed={0.2} />

      <AnimatedLine d="M 0 0 L 700 380" color={COLORS.purple} delay={5} duration={40} opacity={0.25} strokeWidth={1.5} />
      <AnimatedLine d="M 1920 0 L 1220 380" color={COLORS.purple} delay={8} duration={40} opacity={0.25} strokeWidth={1.5} />
      ...
      <AnimatedLine d={circuitPath(100, 1020, 1820, 1020, 4, 'hook-bottom')} color={COLORS.purple} delay={20} duration={50} opacity={0.12} strokeWidth={1} />
      <AnimatedLine d="M 0 200 L 1920 200" color={COLORS.purple} delay={0} duration={60} opacity={0.06} strokeWidth={0.5} />
      <AnimatedLine d="M 0 880 L 1920 880" color={COLORS.purple} delay={10} duration={60} opacity={0.06} strokeWidth={0.5} />

      <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 30 }}>
        <span style={{ opacity: labelOpacity, fontSize: 24, fontWeight: 600, letterSpacing: 6, color: COLORS.lavender, fontFamily: 'system-ui, sans-serif', textTransform: 'uppercase' }}>
