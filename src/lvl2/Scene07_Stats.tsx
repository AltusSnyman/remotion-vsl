...
export const Scene07_Stats: React.FC = () => {
  ...
  // 435 frames total
  const fadeOut = interpolate(frame, [415, 435], [1, 0], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg, opacity: fadeOut }}>
      ...
      <GlowOrb color={COLORS.purple} x={65} y={60} size={400} speed={0.25} />
      <AnimatedLine d="M 180 220 L 180 860" color={COLORS.purple} delay={0} duration={80} opacity={0.12} strokeWidth={1} />
      <AnimatedLine d="M 100 100 L 1820 100" color={COLORS.purple} delay={0} duration={50} opacity={0.06} strokeWidth={0.5} />
      <AnimatedLine d="M 100 980 L 1820 980" color={COLORS.purple} delay={5} duration={50} opacity={0.06} strokeWidth={0.5} />
      <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'flex-start', paddingLeft: 200, gap: 50, flexDirection: 'column' }}>
        ...
        <StatLine value={82} suffix="%" label="saw stronger customer engagement" color={COLORS.purple} startFrame={30} />
      ...
      <AnimatedGraph direction="up" color={COLORS.purple} delay={40} duration={35} width={200} height={80} style={{ position: 'absolute', top: 440, right: 140 }} />
