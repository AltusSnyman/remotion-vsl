// Reusable word-by-word text reveal component
...
type Props = {
  ...
  fontSize?: number;
  color?: string;
  highlight?: string[]; // words to highlight in green
        ...
        return (
          <span
            ...
            style={{
              ...
              color: isHighlighted ? COLORS.whatsappGreen : color,
              textShadow: isHighlighted
                ? `0 0 30px ${COLORS.whatsappGreen}88`
                : undefined,
            }}
          >
            {word}
